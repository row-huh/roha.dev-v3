    ...
    const socialLinks = [
{
  ...
  icon: Twitter,
  color: "hover:bg-gradient-to-r hover:from-moss-700 hover:to-moss-800/40",
},
{
  name: "LinkedIn",
  handle: "roha-pathan",
  ...
  icon: Linkedin,
  color: "hover:bg-gradient-to-r hover:from-moss-800 hover:to-moss-900/40",
},
{
  name: "GitHub",
  handle: "row-huh",
...
},
{
  ...
  icon: MessageCircle,
  color: "hover:bg-gradient-to-r hover:from-moss-700 hover:to-moss-900/40",
},
{
  name: "Medium",
...
},
{
  ...
  icon: Mail,
  color: "hover:bg-gradient-to-r hover:from-moss-900 hover:to-moss-900/40",
},
{
  name: "Phone",
