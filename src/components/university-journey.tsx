    ...
    <section className="py-24 px-8 relative z-10">
      <div className="max-w-5xl mx-auto text-center">
        <motion.div
          ...
          className="mb-12"
        >
          <h2 className="text-2xl font-medium text-moss-400 mb-3">Then I joined University...</h2>
        ...
        >
          <Card className="bg-gray-800/30 border-gray-700/50 backdrop-blur-sm p-8 rounded-3xl flex flex-col items-center justify-center text-center h-48">
            <GraduationCap className="h-12 w-12 text-moss-400 mb-0" />
          ...
          <Card className="bg-gray-800/30 border-gray-700/50 backdrop-blur-sm p-8 rounded-3xl flex flex-col items-center justify-center text-center h-48">
            <Code className="h-8 w-8 text-moss-400 mb-0" />
          ...
          <Card className="bg-gray-800/30 border-gray-700/50 backdrop-blur-sm p-8 rounded-3xl flex flex-col items-center justify-center text-center h-48">
            <Laptop className="h-12 w-12 text-moss-400 mb-0" />
