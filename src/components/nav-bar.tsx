          ...
          <div className="flex items-center gap-4">
            <div className="flex gap-1 bg-gray-800/50 rounded-full p-1 border border-gray-700/50 backdrop-blur-sm">
              ...
              >
                <Link
                  href="/assistant"
                  className={`px-4 py-2 rounded-full text-sm font-medium transition-colors ${pathname === "/assistant" ? "bg-gray-700/50 text-white" : "text-gray-300 hover:bg-gray-700/50 hover:text-white"}`}
                >
                  Ask Pethia
                </Link>
              </motion.div>
