...
"bonnie": {
  ...
  "description": `
      <p class="mb-4">
        Bonnie was an ambitious personal project to create a co-working buddy, much like Jarvis from the Iron Man movies. The core idea was to build an intelligent assistant that could understand my commands, search the web for me, and provide helpful, contextual assistance.
      </p>
      <p class="mb-4">
        However, as this was a pre-GPT project, implementing this level of natural language understanding and general-purpose intelligence was extremely challenging. At the time, my coding skills weren't able to keep up with my imagination, so I eventually gave up on the project. With the advancement of modern language models, the project's original vision is now far more feasible, and it's something I hope to revisit in the future for my own personal use.
      </p>
      <h3 class="text-2xl font-medium text-white mb-4 mt-8">Key Highlights:</h3>
      <ul class="list-disc list-inside text-gray-300 mb-4">
        <li>An ambitious attempt to build a Jarvis-like personal assistant.</li>
        <li>Faced significant challenges in natural language understanding in a pre-GPT era.</li>
        <li>Highlights the gap between ambition and technical skill in an early project.</li>
        <li>A project concept that remains a source of inspiration for future work.</li>
      </ul>
      <h3 class="text-2xl font-medium text-white mb-4 mt-8">Technologies Used:</h3>
      <ul class="list-disc list-inside text-gray-300 mb-4">
        <li>Python</li>
